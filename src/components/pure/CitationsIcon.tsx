...
const CitationsIcon = ({
  ...
  <>
    ...
    >
      <Image
        src={`https://img.shields.io/badge/dynamic/json?label=Google%20Scholar&logo=googlescholar&style=flat&url=https%3A%2F%2Fkaito47802.github.io%2Fdata%2Fscholar.json&query=%24.items%5B%22${articleId}%22%5D.citations&prefix=Cited%20by%20`}
        alt='Citations'
        fill
      />
    </a>
